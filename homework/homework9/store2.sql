...
--
ALTER TABLE `cars`
  ADD CONSTRAINT `cars_ibfk_7` FOREIGN KEY (`brands_id`) REFERENCES `brands` (`brands_id`),
  ...
  ADD CONSTRAINT `cars_ibfk_6` FOREIGN KEY (`regions_id`) REFERENCES `regions` (`regions_id`);
